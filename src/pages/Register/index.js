        ...
        <div class="flex items-center justify-center">
            <div className="bg-gray-800 flex flex-col w-80 sm:w-3/4 border border-gray-900 rounded-lg px-8 py-10">
                ...
                <form className="flex flex-col space-y-8 mt-10" onSubmit={handleSubmit(onSubmit)}>
                    <input ref={register} name="full_name" type="text" placeholder="Full Name" className="border rounded-lg py-3 px-3 bg-gray-700 border-gray-700 placeholder-gray-500"></input>
                    <input ref={register} name="username" type="text" placeholder="Email" className="border rounded-lg py-3 px-3 bg-gray-700 border-gray-700 placeholder-gray-500"></input>
                    <input ref={register} name="password" type="password" placeholder="Password" className="border rounded-lg py-3 px-3 bg-gray-700 border-gray-700 placeholder-gray-500"></input>
